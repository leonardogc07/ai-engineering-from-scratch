...
| 16 | Text Generation — Language Models Before Transformers | ⬚ |
...
| 08 | ControlNet, LoRA & Image Conditioning | ⬚ |
| 09 | Inpainting, Outpainting & Image Editing | ⬚ |
| 10 | Video Generation | ⬚ |
| 11 | Audio Generation | ⬚ |
| 12 | 3D Generation | ⬚ |
...
| 06 | Policy Gradient Methods — REINFORCE | ⬚ |
...
| 07 | RLHF — Reward Model + PPO Training | ⬚ |
...
| 02 | CLIP — Connecting Vision and Language | ⬚ |
...
| 03 | MCP — Model Context Protocol Fundamentals | ⬚ |
...
| 07 | Subagents — Isolated Context, Delegation | ⬚ |
...
| 13 | Hooks — PreToolUse, PostToolUse, SessionStart | ⬚ |
| 14 | Eval-Driven Agent Development | ⬚ |
| 15 | Build a Complete AI Agent from Scratch | ⬚ |
...
| 02 | Autonomous Loops — The Core Pattern | ⬚ |
| 03 | Self-Healing Agents | ⬚ |
| 04 | AutoResearch — Autonomous Research Agents | ⬚ |
...
| 07 | Consensus Algorithms for Agents | ⬚ |
| 08 | Swarm Intelligence — Emergent Behavior | ⬚ |
| 09 | Agent Economies | ⬚ |
| 10 | Worktree Isolation | ⬚ |
| 11 | Hierarchical Swarms | ⬚ |
| 12 | Self-Organizing Systems | ⬚ |
| 13 | DAG-Based Orchestration | ⬚ |
| 14 | Build an Autonomous Agent Swarm | ⬚ |
...
| 07 | CI/CD for ML | ⬚ |
| 08 | A/B Testing & Feature Flags for AI | ⬚ |
| 09 | Data Pipelines | ⬚ |
| 10 | Security | ⬚ |
...
| 05 | Privacy — Differential Privacy, Federated Learning | ⬚ |
| 06 | Interpretability | ⬚ |
...
| # | Project | Status |
|---|---------|--------|
| 01 | Build a Mini GPT & Chat Interface | ⬚ |
| 02 | Build a Multimodal RAG System | ⬚ |
| 03 | Build an Autonomous Research Agent | ⬚ |
| 04 | Build a Multi-Agent Development Team | ⬚ |
| 05 | Build a Production AI Platform | ⬚ |
