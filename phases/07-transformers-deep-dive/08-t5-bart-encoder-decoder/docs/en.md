...
- [NielsRogge, Transformers-Tutorials — `T5/Fine_tuning_Dutch_T5_base_on_CNN_Daily_Mail_for_summarization_(on_TPU_using_HuggingFace_Accelerate).ipynb`](https://github.com/NielsRogge/Transformers-Tutorials/blob/master/T5/Fine_tuning_Dutch_T5_base_on_CNN_Daily_Mail_for_summarization_%28on_TPU_using_HuggingFace_Accelerate%29.ipynb) — real production fine-tune: dataset loading, span-corruption-friendly tokenization, TPU training, beam-search eval.
- [NielsRogge, Transformers-Tutorials — `T5/Fine_tune_CodeT5_for_generating_docstrings_from_Ruby_code.ipynb`](https://github.com/NielsRogge/Transformers-Tutorials/blob/master/T5/Fine_tune_CodeT5_for_generating_docstrings_from_Ruby_code.ipynb) — the "text → text absorbs any task" framing applied to code-to-docstrings.
- [NielsRogge, Transformers-Tutorials — `BART` notebooks](https://github.com/NielsRogge/Transformers-Tutorials) — look for `Fine_tune_BART_for_conditional_generation...` to see BART's denoising head in practice.
- [mlabonne, LLM Course — Ch. 1 "The LLM Architecture" and Ch. 8 "New Trends"](https://github.com/mlabonne/llm-course) — positions decoder-only vs encoder-decoder in modern usage patterns.
